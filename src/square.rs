...
use crate::bitboard::{
    BB, BISHOP_RAYS, BOARD_LENGTH, FILE_A, FILE_H, KNIGHT_JUMPS, ROOK_RAYS, ROW_1,
};
...
const DISTANCE_BETWEEN_RANKS: Internal = 8;
const NUM_OF_FILE_BITS: Internal = 3;
const FILE_BITS: Internal = 7;
...
impl Square {
    ...
    pub fn from(rank: usize, file: usize) -> Square {
        Square((rank * DISTANCE_BETWEEN_RANKS) + file)
    }
    ...
    pub fn change_rank(self, rank: Internal) -> Square {
        assert!(rank < DISTANCE_BETWEEN_RANKS);
        Square((self.file()) | (rank * DISTANCE_BETWEEN_RANKS))
    }

    pub fn rank_down(self) -> Square {
        assert!(self.0 > H1.to_usize());
        Square(self.0 - DISTANCE_BETWEEN_RANKS)
    }

    pub fn rank_up(self) -> Square {
        assert!(self.0 < A8.to_usize());
        Square(self.0 + DISTANCE_BETWEEN_RANKS)
    }
...
pub static ALL_SQUARES: [Square; BOARD_LENGTH] = [
...
pub static DIAGONALS: [BB; BOARD_LENGTH] = [
    BB(0),
    BB(256),
    BB(66048),
    BB(16909312),
...
pub static ANTI_DIAGONALS: [BB; BOARD_LENGTH] = [
