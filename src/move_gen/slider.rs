...
pub mod rank_and_file_tests {
    ...
    #[test]
    pub fn rank_occupied_on_both_sides() {
...
#[cfg(test)]
pub mod diagonal_and_anti_diagonal_tests {
    use crate::{bitboard, square};

    use super::*;

    #[test]
    pub fn empty_diagonal() {
